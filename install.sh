...
curl -O http://rakudo.org/downloads/star/rakudo-star-2016.09.tar.gz
tar -xzf rakudo-star-2016.09.tar.gz
cd rakudo-star-2016.09/
...
make install
echo "export PATH=$HOME/rakudo/rakudo-star-2016.09/install/bin:$HOME/rakudo/rakudo-star-2016.09/install/share/perl6/site/bin:$PATH" > ~/rakudo/setpath.sh
if [ -f ~/.bashrc ]
then
     BASHRC=~/.bashrc
elif [ -f ~/.bash_profile ]
